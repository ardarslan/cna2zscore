    ...
    for DATASET in 'unthresholdedcnapurity2gex' 'rppa2gex'; do
        ...
        for MODEL in "${MODEL_OPTIONS[@]}"; do
            ...
            if [[ $MODEL = 'linear' || $MODEL = 'linear_per_chromosome_all' || $MODEL = 'linear_per_chromosome_24' ]]; then
                ...
                L1_REG_DIAGONAL_COEFF_OPTIONS=(0.00001 0.0001 0.001 0.01 0.1)
                L2_REG_DIAGONAL_COEFF_OPTIONS=(0.00001 0.0001 0.001 0.01 0.1)
                L1_REG_NONDIAGONAL_COEFF_OPTIONS=(0.00001 0.0001 0.001 0.01 0.1)
                L2_REG_NONDIAGONAL_COEFF_OPTIONS=(0.00001 0.0001 0.001 0.01 0.1)
