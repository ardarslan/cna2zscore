...
def process_gene_predictability_data(gex_df: pd.DataFrame, entrezgene_id_to_mean_and_std_gex_mapping_df: pd.DataFrame, thresholded_cna_df: pd.DataFrame) -> pd.DataFrame:
