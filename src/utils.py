...
def get_argument_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--dataset", type=str, default="cnapurity2gex", choices=["unthresholdedcnapurity2gex", "thresholdedcnapurity2gex", "unthresholdedcnapurity2gex", "thresholdedcna2gex", "unthresholdedcna2gex", "rppa2gex"], help="Name of the dataset.")
