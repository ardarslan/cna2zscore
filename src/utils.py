...
def get_argument_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--gene_type", type=str, default="rppa_genes", choices=["breast_cancer_ipac_genes", "breast_cancer_scc_genes", "breast_cancer_ipac_and_rppa_genes", "168_highly_expressed_genes", "1000_highly_expressed_genes", "rppa_genes", "all_genes"])
